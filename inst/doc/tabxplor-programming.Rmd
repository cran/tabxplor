...
- `tabxplor.tab_kable_css` — inline the stylesheet with each `tab_html()` *and* `tab_md()` table (`TRUE`); set `FALSE` in a many-table document and call `tab_css()` once instead (this vignette does), or in a plain-Markdown notebook that wants no stylesheet at all.
